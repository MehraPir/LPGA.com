  ...
  <footer class="site-footer">
    <div class="wrap">
      ...
      <div class="footer-base">
        ...
        <span>Made for code crackers everywhere. Google Play coming soon.</span>
      </div>
    </div>
  </footer>
</body>
...
CTA = '''<div class="article-cta">
  ...
  <div class="hero-ctas" style="justify-content:center;">''' + BADGE + AMAZON_BADGE + '''<span class="store-note">Google Play: coming soon</span></div>
</div>'''
