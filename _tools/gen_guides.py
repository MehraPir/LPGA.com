...
AMAZON_BADGE = '''<a class="badge-store" href="https://www.amazon.com/dp/B0HC616CPG" aria-label="Get Cipher Munch on the Amazon Appstore"><svg viewBox="0 0 212 54" role="img" aria-hidden="true" focusable="false"><rect x="0.75" y="0.75" width="210.5" height="52.5" rx="10" fill="#000" stroke="#a6a6a6" stroke-width="1.5"/><text x="13" y="36" fill="#fff" font-family="Helvetica,Arial,sans-serif" font-size="34" font-weight="500" textLength="24" lengthAdjust="spacingAndGlyphs">a</text><path fill="#FF9900" d="M12.4 39.9c6.9 4.8 17.3 4.6 24.1-.6.6-.4 1.2.2.7.8-2.6 3.1-7.6 5-12.4 5-5.6 0-10.8-2.3-14.2-5.6-.4-.4 0-.9.6-.6z"/><path fill="#FF9900" d="M39.6 38.4c-.5-.6-3-.3-4.1-.2-.3 0-.4-.3-.1-.5 2-1.4 5.2-1 5.6-.5.4.5-.1 3.7-1.9 5.3-.3.2-.6.1-.5-.2.5-1.1 1.4-3.4 1-3.9z"/><text x="56" y="22" fill="#fff" font-family="-apple-system,\'Segoe UI\',Helvetica,Arial,sans-serif" font-size="10.5" letter-spacing="0.4">Available on</text><text x="56" y="41" fill="#fff" font-family="-apple-system,\'Segoe UI\',Helvetica,Arial,sans-serif" font-size="17" font-weight="600">Amazon Appstore</text></svg></a>'''

PLAY_BADGE = '''<a class="badge-store" href="https://play.google.com/store/apps/details?id=com.learningplaygroundapps.ciphermunch" aria-label="Get Cipher Munch on Google Play"><svg viewBox="0 0 212 54" role="img" aria-hidden="true" focusable="false"><rect x="0.75" y="0.75" width="210.5" height="52.5" rx="10" fill="#000" stroke="#a6a6a6" stroke-width="1.5"/><path fill="#00A0FF" d="M14 9 L27 22 L14 35 z"/><path fill="#00E676" d="M14 9 L34 16 L27 22 z"/><path fill="#FFCE00" d="M27 22 L34 16 L40 22 L34 28 z"/><path fill="#FF3A44" d="M27 22 L34 28 L14 35 z"/><text x="56" y="22" fill="#fff" font-family="-apple-system,\'Segoe UI\',Helvetica,Arial,sans-serif" font-size="10.5" letter-spacing="0.4">GET IT ON</text><text x="56" y="41" fill="#fff" font-family="-apple-system,\'Segoe UI\',Helvetica,Arial,sans-serif" font-size="17" font-weight="600">Google Play</text></svg></a>'''
  ...
  <footer class="site-footer">
    <div class="wrap">
      <div class="footer-grid">
        ...
        <div>
          ...
          <ul>
            ...
            <li><a href="''' + AMAZON + '''">Get it on the Amazon Appstore</a></li>
            <li><a href="''' + PLAY + '''">Get it on Google Play</a></li>
      ...
      <div class="footer-base">
        ...
        <span>Made for code crackers everywhere.</span>
      </div>
    </div>
  </footer>
</body>
